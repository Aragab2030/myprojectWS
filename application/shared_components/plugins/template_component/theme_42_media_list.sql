...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8385122506580959)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1808403554001464602)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1808402998989464601)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8385851971580952)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8386136980580952)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8386486064580952)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8386736134580951)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8387016964580951)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8386486064580952)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1808403554001464602)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8387334607580951)
,p_plugin_attribute_id=>wwv_flow_imp.id(8387016964580951)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8387763916580950)
,p_plugin_attribute_id=>wwv_flow_imp.id(8387016964580951)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8388183241580950)
,p_plugin_attribute_id=>wwv_flow_imp.id(8387016964580951)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8388548587580950)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8387016964580951)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8388804177580949)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8389102062580949)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8389416602580949)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8389792855580948)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8390082108580948)
,p_plugin_attribute_id=>wwv_flow_imp.id(8389792855580948)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8390496560580948)
,p_plugin_attribute_id=>wwv_flow_imp.id(8389792855580948)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8390890786580947)
,p_plugin_attribute_id=>wwv_flow_imp.id(8389792855580948)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8391219907580947)
,p_plugin_attribute_id=>wwv_flow_imp.id(8389792855580948)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8391675952580946)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8386736134580951)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1808402998989464601)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8391933555580946)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8392278433580946)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8392557269580945)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8392808357580945)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8393197174580944)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8393493923580944)
,p_plugin_attribute_id=>wwv_flow_imp.id(8393197174580944)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8393826024580944)
,p_plugin_attribute_id=>wwv_flow_imp.id(8393197174580944)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8394223910580943)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8394520602580943)
,p_plugin_attribute_id=>wwv_flow_imp.id(8394223910580943)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8394976617580942)
,p_plugin_attribute_id=>wwv_flow_imp.id(8394223910580943)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8395351336580942)
,p_plugin_attribute_id=>wwv_flow_imp.id(8394223910580943)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8395712319580942)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8396019486580941)
,p_plugin_attribute_id=>wwv_flow_imp.id(8395712319580942)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8396480288580941)
,p_plugin_attribute_id=>wwv_flow_imp.id(8395712319580942)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8396868181580941)
,p_plugin_attribute_id=>wwv_flow_imp.id(8395712319580942)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8397247362580940)
,p_plugin_attribute_id=>wwv_flow_imp.id(8395712319580942)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8397640958580940)
,p_plugin_attribute_id=>wwv_flow_imp.id(8395712319580942)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8398011067580940)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8398327429580939)
,p_plugin_attribute_id=>wwv_flow_imp.id(8398011067580940)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8398797755580939)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808606606158611230)
,p_plugin_id=>wwv_flow_imp.id(8385122506580959)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
