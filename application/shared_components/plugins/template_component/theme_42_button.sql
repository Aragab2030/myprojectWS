...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8382404287580964)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8382716380580963)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8383063486580963)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8383369385580962)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8383677524580962)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8383985002580962)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8384200334580961)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8384553465580961)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8384853850580961)
,p_plugin_id=>wwv_flow_imp.id(8382404287580964)
,p_attribute_scope=>'COMPONENT'
