...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8352064739581037)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8352335898581022)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8352682845581018)
,p_plugin_attribute_id=>wwv_flow_imp.id(8352335898581022)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8353005872581017)
,p_plugin_attribute_id=>wwv_flow_imp.id(8352335898581022)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8353427716581017)
,p_plugin_attribute_id=>wwv_flow_imp.id(8352335898581022)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8353875340581016)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8352335898581022)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8354133950581015)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8354480425581015)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8354709889581015)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8355098494581013)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8355370004581013)
,p_plugin_attribute_id=>wwv_flow_imp.id(8355098494581013)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8355702064581012)
,p_plugin_attribute_id=>wwv_flow_imp.id(8355098494581013)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8356125061581012)
,p_plugin_attribute_id=>wwv_flow_imp.id(8355098494581013)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8356571788581012)
,p_plugin_attribute_id=>wwv_flow_imp.id(8355098494581013)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8356953137581011)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8357242144581011)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8357657029581010)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8358034579581010)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8358407286581010)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8358815188581009)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8359259459581009)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8359659789581009)
,p_plugin_attribute_id=>wwv_flow_imp.id(8356953137581011)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8360000515581008)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808402935756694784)
,p_plugin_id=>wwv_flow_imp.id(8352064739581037)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
