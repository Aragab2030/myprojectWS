...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8411730908580915)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935649599527652607)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935649044515652606)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1678756980785379093)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8412668328580911)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8412919366580910)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8413275622580910)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8413545604580909)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8413817475580909)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8414199524580909)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8414477581580908)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8413817475580909)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1935649599527652607)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8414773472580908)
,p_plugin_attribute_id=>wwv_flow_imp.id(8414477581580908)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8415106317580907)
,p_plugin_attribute_id=>wwv_flow_imp.id(8414477581580908)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8415512429580906)
,p_plugin_attribute_id=>wwv_flow_imp.id(8414477581580908)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8415993536580906)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8414477581580908)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8416251503580905)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8416565042580905)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8416816506580905)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8417160374580904)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8417478923580904)
,p_plugin_attribute_id=>wwv_flow_imp.id(8417160374580904)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8417810509580904)
,p_plugin_attribute_id=>wwv_flow_imp.id(8417160374580904)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8418275744580903)
,p_plugin_attribute_id=>wwv_flow_imp.id(8417160374580904)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8418605268580903)
,p_plugin_attribute_id=>wwv_flow_imp.id(8417160374580904)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8419018403580902)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8414199524580909)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1935649044515652606)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8419301397580902)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8419627912580902)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8419917704580901)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8420252930580901)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8420558971580901)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8420831473580900)
,p_plugin_attribute_id=>wwv_flow_imp.id(8420558971580901)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8421286099580900)
,p_plugin_attribute_id=>wwv_flow_imp.id(8420558971580901)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8421646021580899)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8421983898580899)
,p_plugin_attribute_id=>wwv_flow_imp.id(8421646021580899)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8422367398580899)
,p_plugin_attribute_id=>wwv_flow_imp.id(8421646021580899)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8422715643580898)
,p_plugin_attribute_id=>wwv_flow_imp.id(8421646021580899)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8423102267580898)
,p_plugin_attribute_id=>wwv_flow_imp.id(8421646021580899)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8423519918580898)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8423836596580897)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8424273645580897)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8424679070580897)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8425035143580896)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8425474946580896)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8425842349580895)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8426237891580895)
,p_plugin_attribute_id=>wwv_flow_imp.id(8423519918580898)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8426617506580895)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8426977795580894)
,p_plugin_attribute_id=>wwv_flow_imp.id(8426617506580895)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8427336585580894)
,p_plugin_attribute_id=>wwv_flow_imp.id(8426617506580895)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8427788635580893)
,p_plugin_attribute_id=>wwv_flow_imp.id(8426617506580895)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8428176816580893)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8428413810580893)
,p_plugin_attribute_id=>wwv_flow_imp.id(8428176816580893)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8428835041580892)
,p_plugin_attribute_id=>wwv_flow_imp.id(8428176816580893)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8429282974580892)
,p_plugin_attribute_id=>wwv_flow_imp.id(8428176816580893)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8429648552580892)
,p_plugin_attribute_id=>wwv_flow_imp.id(8428176816580893)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8430044536580891)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8430396872580890)
,p_plugin_attribute_id=>wwv_flow_imp.id(8430044536580891)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8430778050580890)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8431035054580889)
,p_plugin_attribute_id=>wwv_flow_imp.id(8430778050580890)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8431459775580888)
,p_plugin_attribute_id=>wwv_flow_imp.id(8430778050580890)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8431820118580888)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8432104245580888)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8432499791580887)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1678756980785379093)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8432749105580887)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8433068778580886)
,p_plugin_attribute_id=>wwv_flow_imp.id(8432749105580887)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8433437947580885)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8433742184580885)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816863489743474221)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816864749263478369)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1519911974847715791)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803269861069067488)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803949161799150592)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816861554676429235)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816862888066443092)
,p_plugin_id=>wwv_flow_imp.id(8411730908580915)
