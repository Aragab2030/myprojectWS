...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8176808800581148)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8177109748581147)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8177403367581147)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8177776654581147)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8178024147581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8178318302581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8178605071581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8178990970581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8179209826581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8179504123581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8179860061581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8180138359581146)
,p_page_template_id=>wwv_flow_imp.id(8176808800581148)
