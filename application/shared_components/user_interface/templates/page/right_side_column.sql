...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8180525282581145)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8180827075581145)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8181130968581145)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8181428422581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8181758309581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8182015586581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8182371875581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8182623419581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8182948134581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8183210586581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8183558151581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8183867480581144)
,p_page_template_id=>wwv_flow_imp.id(8180525282581145)
