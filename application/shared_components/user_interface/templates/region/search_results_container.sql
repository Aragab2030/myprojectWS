...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8273789837581093)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8274061448581093)
,p_plug_template_id=>wwv_flow_imp.id(8273789837581093)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8274340826581092)
,p_plug_template_id=>wwv_flow_imp.id(8273789837581093)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8274619618581092)
,p_plug_template_id=>wwv_flow_imp.id(8273789837581093)
,p_name=>'Sub Regions'
