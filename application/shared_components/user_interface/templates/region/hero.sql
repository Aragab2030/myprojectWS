...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8253185985581103)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8253496414581103)
,p_plug_template_id=>wwv_flow_imp.id(8253185985581103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8253765651581103)
,p_plug_template_id=>wwv_flow_imp.id(8253185985581103)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8254020912581102)
,p_plug_template_id=>wwv_flow_imp.id(8253185985581103)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8254360157581102)
,p_plug_template_id=>wwv_flow_imp.id(8253185985581103)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8254682375581102)
,p_plug_template_id=>wwv_flow_imp.id(8253185985581103)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
