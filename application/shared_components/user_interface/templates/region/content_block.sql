...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8238742787581111)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8239055737581110)
,p_plug_template_id=>wwv_flow_imp.id(8238742787581111)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8239362429581110)
,p_plug_template_id=>wwv_flow_imp.id(8238742787581111)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8239686478581110)
,p_plug_template_id=>wwv_flow_imp.id(8238742787581111)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8239921506581110)
,p_plug_template_id=>wwv_flow_imp.id(8238742787581111)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8240219481581110)
,p_plug_template_id=>wwv_flow_imp.id(8238742787581111)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8240574680581110)
,p_plug_template_id=>wwv_flow_imp.id(8238742787581111)
,p_name=>'Sub Regions'
