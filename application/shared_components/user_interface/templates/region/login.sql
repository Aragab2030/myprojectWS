...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8271293168581094)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8271525773581094)
,p_plug_template_id=>wwv_flow_imp.id(8271293168581094)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8271886606581094)
,p_plug_template_id=>wwv_flow_imp.id(8271293168581094)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8272184522581094)
,p_plug_template_id=>wwv_flow_imp.id(8271293168581094)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8272439668581093)
,p_plug_template_id=>wwv_flow_imp.id(8271293168581094)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8272750332581093)
,p_plug_template_id=>wwv_flow_imp.id(8271293168581094)
,p_name=>'Sub Regions'
