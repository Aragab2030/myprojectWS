...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8286224716581087)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8286597485581087)
,p_plug_template_id=>wwv_flow_imp.id(8286224716581087)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8286830627581087)
,p_plug_template_id=>wwv_flow_imp.id(8286224716581087)
,p_name=>'Tabs'
