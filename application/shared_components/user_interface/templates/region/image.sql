...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8222778622581119)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8223018960581118)
,p_plug_template_id=>wwv_flow_imp.id(8222778622581119)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8223361636581118)
,p_plug_template_id=>wwv_flow_imp.id(8222778622581119)
,p_name=>'Sub Regions'
