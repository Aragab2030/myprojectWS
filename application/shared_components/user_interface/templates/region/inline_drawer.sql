...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8256603430581101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8256920747581101)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8257221469581101)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8257586184581101)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8257837874581101)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8258158937581101)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8258406235581100)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8258762223581100)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8259073834581100)
,p_plug_template_id=>wwv_flow_imp.id(8256603430581101)
,p_name=>'Sub Regions'
