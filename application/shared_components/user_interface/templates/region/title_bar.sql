...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8288800677581086)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8289127718581086)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8289429051581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8289736252581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8290032499581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8290365781581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8290646140581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8290966885581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8291200840581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8291549529581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8291851298581085)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8292171419581084)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8292451701581084)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8292704958581084)
,p_plug_template_id=>wwv_flow_imp.id(8288800677581086)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
