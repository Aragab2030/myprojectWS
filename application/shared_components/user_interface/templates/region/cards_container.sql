...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8236817478581111)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8237159889581111)
,p_plug_template_id=>wwv_flow_imp.id(8236817478581111)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8237481598581111)
,p_plug_template_id=>wwv_flow_imp.id(8236817478581111)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8237736903581111)
,p_plug_template_id=>wwv_flow_imp.id(8236817478581111)
,p_name=>'Sub Regions'
