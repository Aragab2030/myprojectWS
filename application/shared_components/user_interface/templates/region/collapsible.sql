...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8243322043581108)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8243619520581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8243929453581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8244216385581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8244511097581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8244816560581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8245138376581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8245458703581108)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8245720545581107)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8246049465581107)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8246334283581107)
,p_plug_template_id=>wwv_flow_imp.id(8243322043581108)
,p_name=>'Sub Regions'
