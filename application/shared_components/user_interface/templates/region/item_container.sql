...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8268728508581095)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8269031444581095)
,p_plug_template_id=>wwv_flow_imp.id(8268728508581095)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8269328115581095)
,p_plug_template_id=>wwv_flow_imp.id(8268728508581095)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8269607055581095)
,p_plug_template_id=>wwv_flow_imp.id(8268728508581095)
,p_name=>'Button Start'
