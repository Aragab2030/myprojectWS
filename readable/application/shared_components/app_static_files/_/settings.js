...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: 'oda-895f7cb97d3b4f1ca246dffde4cbf24d-da15.data.digitalassistant.oci.oraclecloud.com/',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: 'b4f1d86e-f5c0-409a-b34a-a11a2003a7d7',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
