...
@@workspace/credentials/oci_iam_web_credentials.sql
@@workspace/credentials/credentials_for_oic_get_person_info_by_id.sql
@@workspace/remote_servers/oicconnectm_axpnesiqlw1a_je_integration_me_jeddah_1_ocp_oraclecloud_com_ic_api.sql
@@application/shared_components/data_profiles/oic_get_person_info_by_id.sql
@@application/shared_components/web_sources/oic_get_person_info_by_id.sql
...
@@application/shared_components/files/embedding_js.sql
@@application/shared_components/files/settings_js.sql
@@application/shared_components/files/web_sdk_js.sql
@@application/shared_components/files/web_sdk_min_js.sql
...
@@application/shared_components/user_interface/lovs/lov_gender.sql
@@application/shared_components/user_interface/lovs/lov_nationality.sql
...
@@application/shared_components/security/authentications/oci_iam_authentication_scheme.sql
